...
public class IdlingTest {
    ...
    @Before
    public void reqisteridlingResource() {
        IdlingRegistry.getInstance().register(EspressoIdlingResources.idlingResource);
    }

    @After
    public void unreqisteridlingResource() {
...
//        recyclerView.check(CustomViewAssertions.isRecyclerView());
        ...
        ViewInteraction itemSewen = onView(allOf(withId(R.id.item_number), withText("7")));
        itemSewen.check(matches(withText("7")));
